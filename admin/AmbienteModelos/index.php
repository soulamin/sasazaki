...
<section class="content">
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-md btn-primary" id="btnAmbiente_Modelo">
                                    <i class="fa fa-plus"></i> Cadastro de Ambiente_Modelo</button>
                            </div>
                            <div class="col-md-12 table-responsive text-sm"><br>

                                <table class="table table-bordered table-striped dataTable  text-sm" id="TabelaAmbiente_Modelo">
            ...
            <div class="modal fade" id="ModalIncluirAmbiente_Modelos" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title blink">Cadastro de Ambiente/Modelo</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="FrmSalvar_AmbienteModelo" method="post" action="" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>Ambiente</label>
                                        <select class="form-control comboambiente" type="text" name='txt_ambiente'></select><br>
                                    </div>

                                    <div class="col-md-12 row" style="border: 1px solid #dddddd">
                                        <div class="col-md-12">
                                            <label class="text-lg">Adicionar Modelo</label><br>
                                            <select class="selectmultiplo listamodelo" style="width:100%" name="txt_modelo[]" multiple="multiple"></select>
                                        </div>
                                    </div>
                                </div>
            ...
            echo '<script src="../../controller/AmbienteModeloController.js?' . $hr . '"></script>';
            ?>