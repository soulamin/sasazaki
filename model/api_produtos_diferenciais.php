...
$urlaut = "http://187.92.100.10:8180/api/esp/v1/sszk-prod-dif.r";
$dados = array();
...
$dd = $j->items[0]->{'v-ds-tabelas'}->{'tt-sk-prod-dif'};
...
foreach ($dd as $dados) {
    ...
    $sql_select = "SELECT COUNT(codigo_produto) AS qtd FROM produtos_diferenciais WHERE codigo_produto = :codigo_produto ";
    ...
    if ($linha['qtd'] == 0) {
        ...
        $sql_insert = "INSERT INTO produtos_diferenciais (codigo_produto,codigo_diferencial)
                                          VALUES (:codigo_produto,:codigo_diferencial) ";
        ...
        $sql_update = "UPDATE produtos_diferenciais SET codigo_diferencial = :codigo_diferencial
